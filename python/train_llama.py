#!/usr/bin/env python3
# ============================================================================
# train_llama.py — LoRA fine-tuning for Llama 3.2 1B
...
def load_base_model(config: TrainingConfig):
    """Load Llama 3.2 base model with LoRA setup"""
...
def main():
    ...
    parser.add_argument("--output", default="./llama3_finetuned", help="Output directory")
