#!/usr/bin/env python3
"""
train_llama_simple.py — Simplified Llama 3.2 LoRA Training
===========================================================
Single script for Kaggle and Paperspace GPU training.

Usage:
    1. Kaggle: Upload this file + requirements.txt + train.jsonl
    2. Run: !python train_llama_simple.py --data train.jsonl

After training, download the output from ./llama3_finetuned/final/
"""
